...
1. Eigenes JPG/PNG/WebP auswählen oder einen Hintergrund aus zwei Farben und einem von zwölf generativen Mustern erzeugen: Verlauf, Strahlen, Streifen, Punkte, Körnung, Blitze, Spritzer, Risse, Schachbrett, Wirbel, Höhenlinien oder Marmor. Musterfarbe, Musterstärke (Deckkraft, 5–90 %) und Musterdichte (Abstand/Anzahl der Formen, 0,3×–3×) sind frei einstellbar. Die Vorschau zeigt bereits die Konzertdaten. Neue Farbstimmungen lassen sich per Knopfdruck erzeugen.
