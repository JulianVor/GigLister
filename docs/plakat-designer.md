...
1. Eigenes JPG/PNG/WebP auswählen oder einen Hintergrund aus zwei Farben und einem von zehn Mustern erzeugen: Verlauf, Strahlen, Streifen, Punkte, Körnung, Blitze, Spritzer, Risse, Schachbrett oder Wirbel. Musterfarbe und Musterstärke (Deckkraft der Musterlinien/-flächen, 5–90 %) sind frei einstellbar. Die Vorschau zeigt bereits die Konzertdaten. Neue Farbstimmungen lassen sich per Knopfdruck erzeugen.
